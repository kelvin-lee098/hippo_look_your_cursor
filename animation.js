...
//
const earWiggle2 = gsap.timeline({ paused: true, repeat: 2 });
earWiggle2.set('.ear-left', { transformOrigin: "center center" });
earWiggle2.to('.ear-left', { duration: 0.1, rotation: -45 });
earWiggle2.to('.ear-left', { duration: 0.1, rotation: 0 });

window.setInterval(earWigglePlay2, 5000);

function earWigglePlay2() { earWiggle2.play(0); }
